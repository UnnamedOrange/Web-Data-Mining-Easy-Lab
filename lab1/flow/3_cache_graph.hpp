...
namespace flow
{
    ...
    inline bool cache_graph()
    {
        ...
        if constexpr (false)
        {
            ...
            link_names.sort();
            link_names.save(global::working_dir / "link_names.txt");
        }
        ...
        // Save.
        global::node_names.save(global::working_dir / "node_names.txt");
        global::graph.save(global::working_dir / "graph.dat");
